...
class ViewController: UIViewController,UINavigationControllerDelegate, UIImagePickerControllerDelegate {
    ...
    func drawMaskImage(image: UIImage) -> UIImage {
        ...
        let maskImage = UIImage(named: "lifeistech")
        ...
        // maskRectで推定した範囲にmaskImageを書き出す
    ...
    @IBAction func processBittonTapped(sender: UIButton) {
        ...
        let secondAction = UIAlertAction(title: "Life is tech!", style: .Default) {
            action in
    ...
    func postToSNS(serviceType: String) {
        ...
        //SLComposeViewContrllerのインスタンス化し、ServiceTypeを指定.
